...
{
    public const TYPES = ['quotation', 'sales_order', 'delivery_receipt', 'sales_invoice', 'collection_receipt', 'purchase_request', 'purchase_order', 'receiving_report', 'purchase_invoice', 'supplier_payment', 'expense_voucher', 'cash_receipt', 'cash_disbursement', 'fund_transfer', 'petty_cash_voucher', 'cash_adjustment', 'inventory_opening_balance', 'inventory_adjustment', 'inventory_transfer', 'inventory_physical_count', 'journal_entry'];
