...
{
    public const TYPES = ['quotation', 'sales_order', 'delivery_receipt', 'sales_invoice', 'collection_receipt', 'purchase_request', 'purchase_order', 'receiving_report', 'purchase_invoice', 'supplier_payment', 'expense_voucher', 'inventory_adjustment', 'journal_entry'];
