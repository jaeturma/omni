 ...
 */
#[Fillable(['code', 'name', 'type', 'bank_id', 'branch_name', 'account_number', 'account_holder_name', 'currency', 'opening_balance', 'opening_balance_date', 'active', 'allow_receipts', 'allow_disbursements', 'allow_transfers', 'allow_reconciliation', 'notes', 'opening_balance_set_at', 'opening_balance_set_by', 'activated_at', 'activated_by', 'deactivated_at', 'deactivated_by', 'deactivation_reason', 'created_by', 'updated_by'])]
class FinancialAccount extends Model
{
    ...
    {
        return ['type' => FinancialAccountType::class, 'account_number' => 'encrypted', 'opening_balance' => 'decimal:4',
