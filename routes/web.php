...
use App\Http\Controllers\ProductionCutoverController;
...
Route::middleware(['auth', EnsureUserIsActive::class])->group(function () {
    ...
    Route::get('/production-cutovers', [ProductionCutoverController::class, 'index'])->name('production-cutovers.index');
    Route::post('/production-cutovers', [ProductionCutoverController::class, 'store'])->name('production-cutovers.store');
    Route::patch('/production-cutovers/{productionCutover}/approve', [ProductionCutoverController::class, 'approve'])->name('production-cutovers.approve');
    Route::patch('/production-cutovers/{productionCutover}/activate', [ProductionCutoverController::class, 'activate'])->name('production-cutovers.activate');
    ...
    Route::get('/bir-1701q/{bir1701q_worksheet}', [Bir1701qWorksheetController::class, 'show'])->name('bir-1701q.show');
    Route::patch('/bir-1701q/{bir1701q_worksheet}', [Bir1701qWorksheetController::class, 'update'])->name('bir-1701q.update');
    Route::post('/bir-1701q/{bir1701q_worksheet}/submit', [Bir1701qWorksheetController::class, 'submit'])->name('bir-1701q.submit');
    Route::post('/bir-1701q/{bir1701q_worksheet}/review', [Bir1701qWorksheetController::class, 'review'])->name('bir-1701q.review');
    Route::post('/bir-1701q/{bir1701q_worksheet}/approve', [Bir1701qWorksheetController::class, 'approve'])->name('bir-1701q.approve');
    Route::post('/bir-1701q/{bir1701q_worksheet}/revise', [Bir1701qWorksheetController::class, 'revise'])->name('bir-1701q.revise');
    Route::get('/bir-1701q/{bir1701q_worksheet}/export', [Bir1701qWorksheetController::class, 'export'])->name('bir-1701q.export');
