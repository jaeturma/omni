...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::query()->whereIn('name', ['business-profile.manage', 'tax-profile.manage', 'system-settings.manage', 'quotations.issue', 'deliveries.update'])->where('guard_name', 'web')->delete();
        $permissions = [
