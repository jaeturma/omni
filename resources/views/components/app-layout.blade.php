...
@php
    $navigationGroups = [
        ...
        'Setup' => [
            ...
            ['Tax Dashboard', 'tax-dashboard.index', 'tax-dashboard.view'],
            ['Tax Reconciliation', 'tax-reconciliations.index', 'tax-reconciliation.view'],
            ['BIR 2551Q Worksheet', 'bir-2551q.index', 'bir-2551q.view'],
            ['BIR 1701Q Worksheet', 'bir-1701q.index', 'bir-1701q.view'],
            ['Withholding Reconciliation', 'withholding-reconciliation.index', 'withholding-certificates.view'],
            ['Books of Accounts', 'books-of-accounts.index', 'books-of-accounts.view'],
            ['Tax Schedules', 'tax-schedules.index', 'tax-schedules.view'],
